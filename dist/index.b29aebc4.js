...
window.onload = function() {
    let sumbitButton = document.querySelector("#btn");
    sumbitButton.addEventListener("click", getUserInput);
    creatingTodo();
};
function getUserInput() {
    let input = document.getElementById("user-input");
    if (input.value.length == 0) alert("Cant add nothing as a todo, please write something");
    else {
        let newTodo = new _todolist.Todolist(input.value, false);
...
function creatingTodo() {
    ...
    let userInput = document.getElementById("ul");
    userInput.innerHTML = "";
...
},{"./models/todolist":"kcXrJ"}],"kcXrJ":[function(require,module,exports) {
